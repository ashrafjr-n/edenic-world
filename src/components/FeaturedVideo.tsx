...
/**
 * Static placeholder thumbnail today; once real videos exist this swaps to
 * an actual YouTube thumbnail/player without touching the surrounding layout.
 */
    ...
    <div>
      ...
      <div className="mt-[22px] grid gap-[28px] lg:grid-cols-[1.5fr_1fr] lg:items-center">
        ...
        >
          ...
          <span className="absolute right-4 bottom-4 rounded-full bg-edenic-bg/70 px-[12px] py-[4px] text-[13px] font-semibold text-white backdrop-blur-sm">
